...
public class ViewPagerTabListViewFragment extends BaseFragment implements AppListAdapter.OnItemClickListener {
    ...
    private void setHotApp() {
        GsonGetRequest<AppListBean> gsonGetRequest = ApiRequest.getAppList(
                ApiHelper.P_RECOMMEND,
                ApiHelper.TYPE_APP,
                1,
                new Response.Listener<AppListBean>() {
                    @Override
    ...
    @Override
    public void onDownloadClick(View view, int position, AppInfoBean app) {
            ...
            default:
                ...
                try {
                    MarketApplication.getDownloadManager()
                        .addNewDownload("http://hot.m.shouji.360tpcdn.com/160815/663bf20ac1cdfb3d91247d22292806f3/com.qihoo.appstore_300050185.apk", app.getName(), target, true, true, app.getIcon(), app.getVer(),
    ...
    @Override
    public void onItemClick(View view, int position, AppInfoBean app) {
