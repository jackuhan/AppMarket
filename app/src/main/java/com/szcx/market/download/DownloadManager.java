...
public class DownloadManager {
    ...
    public synchronized void addNewDownload(String url, String fileName, String target,
                               boolean autoResume, boolean autoRename,String icon,String ver,int id,
                               final RequestCallBack<File> callback,final DownloadInfo downloadInfo) throws DbException {
