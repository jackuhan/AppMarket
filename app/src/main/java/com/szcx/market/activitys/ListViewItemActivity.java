 ...
 */
public class ListViewItemActivity extends BaseActivity {
  @ViewInject(R.id.download_label) private TextView label;
  @ViewInject(R.id.download_state) private TextView state;
  @ViewInject(R.id.download_pb) private ProgressBar progressBar;
  @ViewInject(R.id.download_remove_btn) private Button removeBtn;
  ...
  private Watcher watcher = new Watcher() {
    ...
    @Override public void ontifyDownloadDataChange() {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    if (progressBar != null) {
      progressBar.setProgress(
          (int) (downloadInfo.getFileLength() == 0 ? 0 : downloadInfo.getProgress() * 100 / downloadInfo.getFileLength()));
    }
